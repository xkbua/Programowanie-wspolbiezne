...
namespace Logic
{
    public class Board
    {
        ...
        {
            // Obliczanie prędkości względnej kul po kolizji
            ...
            // Transformacja prędkości do układu odniesienia kolizji
            ...
            // Obliczanie nowych prędkości kul w układzie odniesienia kolizji
            ...
            // Transformacja z powrotem do oryginalnego układu odniesienia
            ...
            // Obliczanie odległości między kulkami
            ...
            // Obliczanie sumy promieni kul
            float radiusSum = ball1.Radius + ball2.Radius;

            if (distance < radiusSum)
            {
                // Obliczanie różnicy między rzeczywistą odległością a sumą promieni
                float overlap = radiusSum - distance;

                // Aktualizacja pozycji kul, aby zapewnić, że nie są w kontakcie
